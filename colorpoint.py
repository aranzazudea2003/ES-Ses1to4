...
colors = ["red", "blue", "green", "yellow", "purple", "pink", "beige",
          "bordeaux", "marsala", "peach", "turqoise", "saffron", "magenta"]
...
class ColoredPoint(Point): # this class inherits from point
    ...
    def __init__(self, x, y, color):
        ...
        if color in self.COLORS:
            ...
            raise Exception(f"This is an invalid color. Accepted colors are {self.COLORS}")
    def __str__(self):
